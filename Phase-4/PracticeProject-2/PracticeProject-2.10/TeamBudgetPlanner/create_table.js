...
function initialize(){
    if (localStorage.getItem("myData") ===null){
        //alert("inside if")
        myData = [new Deal(1,"Innernext","Aurora Project","Prathmesh",500000),
                new Deal(2,"Multi Prospect","Fierfly","Virat",200000),
                new Deal(3,"Interqa","Fusion","Rohit",150000),
 	            new Deal(4,"Ambryn","Kryptonite","Rahul",120000)
        ]
